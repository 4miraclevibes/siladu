        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" style="background-color: #075308 !important">
            ...
            <ul class="menu-inner py-1 mt-3">
              ...
              <li class="menu-item {{ Route::is('laboratories*') ? 'active' : '' }}">
                <a href="{{ route('laboratories.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('packages*') ? 'active' : '' }}">
                <a href="{{ route('packages.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('parameters*') ? 'active' : '' }}">
                <a href="{{ route('parameters.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('methods*') ? 'active' : '' }}">
                <a href="{{ route('methods.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('locations*') ? 'active' : '' }}">
                <a href="{{ route('locations.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('quality-standarts*') ? 'active' : '' }}">
                <a href="{{ route('quality-standarts.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('dashboard.transactions.index') ? 'active' : '' }}">
                <a href="{{ route('dashboard.transactions.index') }}" class="menu-link text-white">
              ...
              <li class="menu-item {{ Route::is('dashboard.payments.index') ? 'active' : '' }}">
                <a href="{{ route('dashboard.payments.index') }}" class="menu-link text-white">
