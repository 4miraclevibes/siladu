...
<div class="container content">
    <h2>Form Pengajuan Uji - Instansi</h2>

    <form action="{{ route('instansi.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="category" value="instansi">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Email Instansi</label>
                        <input type="email" class="form-control" name="email_instansi" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Telepon Instansi</label>
                        <input type="number" class="form-control" name="telepon_instansi" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Alamat Instansi</label>
                        <textarea class="form-control" name="alamat_instansi" required></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Status Pengembalian sampel</label>
                        <div>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Status pengembalian sisa sampel</label>
                        <div>
                            <div class="form-check form-check-inline">
